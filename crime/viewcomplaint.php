...
<div class="bg-img">
  <form action="" class="container" method="post">
	<h1>VIEW COMPLAINT STATUS</h1>
	 <div align="center">
	<table border='1'><tr><td>COMPLAINT ID</td><td>STATION NAME</td><td>SUBJECT</td><td>COMPLAINT TYPE</td><td>NAME</td><td>ADDRESS</td><td>CITY</td><td>PINCODE</td><td>PHONE</td><td>YOUR COMPLAINT</td><td>ACTION</td></tr>
	 <?php
...
echo "<tr><td>$a</td><td>$b</td><td>$c</td><td>$d</td><td>$e</td><td>$f</td><td>$g</td><td>$h</td><td>$i</td><td>$j</td><td><a href='delete.php'>DELETE</a></td></tr>";
echo "</center>";
}
?>
</table>
